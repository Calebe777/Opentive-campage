...
export default function RegisterPage() {
  ...
  const onSubmit = async (values: RegisterFormValues) => {
    ...
    try {
      ...
      toast("Cadastro criado com sucesso! Faça login para entrar.", "success");
    } catch (err: any) {
      console.error(err);
      toast(err.message || "Erro ao realizar cadastro. Tente outro e-mail.", "error");
    } finally {
